...
import {Transform as TransformStream, pipeline} from 'node:stream';
import {crc32 as calculateCrc32} from '@node-rs/crc32';
import {isObject, isBoolean, isPositiveInteger, isPositiveIntegerOrZero} from 'is-it-type';
import assert from 'simple-invariant';

// Imports
import {INTERNAL_SYMBOL, uncertainUncompressedSizeEntriesRegistry} from './shared.js';
